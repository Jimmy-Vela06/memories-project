...
export const getPosts = async (req, res) => {
  ...
  try {
    const LIMIT = 6;
    const startIndex = (Number(page) - 1) * LIMIT; // get startingg index of every page
...
export const getPostsBySearch = async (req, res) => {
  ...
  try {
    const title = new RegExp(searchQuery, 'i'); // ingore case : TEST test  TEst --> test
...
//     console.log("Post created - GREAT SUCCESS");
//   } catch (error) {
